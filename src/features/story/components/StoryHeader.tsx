      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        >
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-black bg-success" />
          </div>
          <div className="flex flex-col gap-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {story.isVerified && (
                <svg className="h-4 w-4 flex-shrink-0 text-primary" fill="currentColor" viewBox="0 0 40 40">
            ...
            {currentContent.isCloseFriend && (
              <div className="flex w-fit items-center gap-1 rounded-full border border-white/20 bg-gradient-to-r from-success to-primary px-2 py-0.5 text-xs font-semibold text-white shadow-lg backdrop-blur-sm">
